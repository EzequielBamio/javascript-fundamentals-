        ...
        if(!e.target.id.value) {
            ...
            try {
                let options = {
                    ...
                    res = await fetch('http://localhost:5555/playersArg', options),
                    json = await res.json();
            ...
            try {
                let options = {
                    ...
                    res = await fetch(`http://localhost:5555/playersArg/${e.target.id.value}`, options),
                    json = await res.json();
        ...
        if(isDelete) {
            try {
                let options = {
                    ...
                    res = await fetch(`http://localhost:5555/playersArg/${e.target.dataset.id}`, options),
                    json = await res.json();
